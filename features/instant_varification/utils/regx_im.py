from features.instant_varification.utils.image_preprocessing import image_to_text
from features.instant_varification import extract_texts_file, searched_data_file, os ,re
    ...
    with open(extract_texts_file, "r", encoding="utf-8") as f:
        for index, line in enumerate(f):
            if re.search(r'ID NO:', line):
                ...
                if id_match:
                    info["nid"] = int(id_match.group()) # type: ignore
